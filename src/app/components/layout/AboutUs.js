  ...
  return (
    <section className="text-center my-16" id="about">
      ...
      <div className="text-gray-500 max-w-lg mx-auto mt-4 flex flex-col gap-4">
        <p>
          At GrocHub, we are passionate about simplifying the way you shop for
        ...
        <p>
          GrocHub was born out of a desire to revolutionize the traditional
        ...
        <p>
          We invite you to join the GrocHub family and experience the future
